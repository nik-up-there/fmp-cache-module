...
<div align="center"><strong>Scalable caching system in your NestJS backend with Redis</strong></div>
<div align="center">Module adding a Redis instance to your backend</div>
...
<div align="center">
  <sub>Created by <strong><a href="https://github.com/nik-up-there">Nik_up_there</a></strong></sub>
</div>

## Features included in the module

Hi, if you want to add a Redis cache within your NestJS backend, you are at the right place. <br />
